 ...
 *
 */
export const finishBatch = <ThrowOnError extends boolean = false>(options?: Options<FinishBatchData, ThrowOnError>) => (options?.client ?? client).post<FinishBatchResponses, FinishBatchErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/v1/batch/finish',
    ...options
});
